...
cat results.txt| awk '{print $31,$38,$32,$39,$46}' | sort -u | while read line
do 
...
#echo $sample
/inside/home/common/bin/Rscript fusion_script_with_function_aesthetic.R $gene1 $break1 $gene2 $break2 $sample all_fusions_results.tsv
done
